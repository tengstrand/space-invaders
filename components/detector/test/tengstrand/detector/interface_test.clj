(ns tengstrand.detector.interface-test
  (:require [clojure.test :as test :refer :all]
            [tengstrand.detector.interface :as detector]))

(def radar-rows ["----o--oo----o--ooo--ooo--o------o---oo-o----oo---o--o---------o----o------o-------------o--o--o--o-"
                 ...
                 "--o------o-----o------------oo---------oo-o-o--ooo----oo----o--o--o----o--o-o-----o-o------o-o------"
                 "----------o---o----o----------o------o--o------o--------o--------o--oo-o-----oo-oo---o--o---o-----oo"
                 "---------ooooooo-----o---o--------------o--o----o--o-o------------oo------o--o-o---o-----o----------"
                 "------o-oo-ooo-oo------o-o---o-----oo-o--------o---------------------------------o-o-o--o-----------"
                 "-------ooooooooooo-----o-----o-------o-------------------o-----o---------o-o-------------o-------oo-"
                 "-o--o--o-ooooooo-oo-o-----o--o--o--oo-------------o----ooo----o-------------o----------oo----o---o-o"
                 "-o--o--o-o-----o-oo----oo------o--o-------o--o-----o-----o----o-----o--o----o--oo-----------o-------"
                 "-o--------oo-oo--------o----o----------o--o----o-----o-----o-------o-----------o---o-o--oooooo-----o"
                 ...
                 "------o--------o-ooooo----o---o--o-----o---------------o-o-------o-----o----------------oo----------"
                 "o-------oo----o--oooooo-o---o--o------oooo----------o-oo-------o---o----------o--------oooo---------"
                 "-o---o----------o--oo-oo-o---o-----o-o-----------------------oo--o------o------o------oooooo--------"
                 "-----oo-o-o-o---ooooooooo----o----o--------o--o---oo---o------------o----------o-o---oo-oo-oo-o--oo-"
                 "------o------o---ooo-o---------------------------o--o---o---o----o--o-------o-----o--oooooooo-o----o"
                 "-------o----------ooo-o-----o----o---o--o-oo--o--o-o--o------o--o-oo---ooo-------------o--o-------o-"
                 "-o-------o------o-o--ooo--o---o---oo-----o----o-------------o----o-ooo-o------o--o-o--o-oo-o--------"
                 "---oo--o---o-o---------o---o--------------o--o-----o-------o-----o--o---o-oo--------oo-o--o-o-o-----"
...
(deftest detect-invaders
  (is (= [{:x 7, :y 7}
          {:x 85, :y 29}]
         (detector/detect-invaders radar-rows))))
